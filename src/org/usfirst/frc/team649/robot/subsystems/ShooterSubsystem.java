...
public class ShooterSubsystem extends Subsystem {
	...
	public static final double FARSHOT_FLYWHEEL_TARGET_RPM = 3500;//3500
	public static final double FARSHOT_FLYWHEEL_MAX_SHOOT_POWER = 0.8;//0.8
	public static final double FARSHOT_FLYWHEEL_MIN_SHOOT_POWER = 0.6;//0.6
